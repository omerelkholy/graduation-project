                            ...
                            <div class="border p-4 rounded">
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input name="products[0][product_quantity]" type="number" min="1"
                                                      class="mt-1 block w-full" required/>
                                    </div>
                                    <div>
                                        <x-input-label value="Weight (kg)"/>
                                        <x-text-input name="products[0][product_weight]" type="number" step="0.01" min="0"
                                                      class="mt-1 block w-full" required/>
                                    </div>
                                    <div>
                                        <x-input-label value="Price (EGP)"/>
                                        <x-text-input name="products[0][product_price]" type="number" step="0.01" min="0"
                                                      class="mt-1 block w-full" required/>
                                    </div>
                                </div>
                            </div>
